...
export function WorkflowList() {
    ...
    const tabs: { id: Tab; label: string }[] = [
        { id: "all", label: t("workflows.allWorkflows") },
        { id: "builtin", label: t("workflows.builtIn") },
        { id: "custom", label: t("workflows.custom") },
        { id: "hidden", label: t("workflows.hidden") },
    ];
    ...
    const getTypeMeta = (type: MikeWorkflow["type"]) =>
        type === "tabular"
            ? { label: t("workflows.tabular"), Icon: Table2, className: "text-violet-700" }
            : {
                  label: t("workflows.assistant"),
                  Icon: MessageSquare,
        ...
        <div className="relative" ref={typeFilterRef}>
            ...
            >
                {typeFilter
                    ? typeFilter === "tabular"
                        ? t("workflows.tabular")
                        : t("workflows.assistant")
                    : t("workflows.filterByType")}
    ...
    const practiceFilterButton = (
        <div className="relative" ref={practiceFilterRef}>
            ...
            >
                {practiceFilter ?? t("workflows.filterByPractice")}
                <ChevronDown className="h-3 w-3" />
            </button>
            {practiceFilterOpen && (
            ...
            <div className="flex-1 overflow-auto">
                <div className="min-w-max">
                    ...
                    <div className="flex items-center h-8 pr-8 border-b border-gray-200 text-xs text-gray-500 font-medium select-none">
                        ...
                        <div className="ml-auto w-28 shrink-0">{t("workflows.type")}</div>
                        <div className="w-40 shrink-0">{t("workflows.practice")}</div>
                        <div className="w-28 shrink-0">{t("workflows.source")}</div>
                            ...
                            {activeTab === "custom" ? (
                                <>
                                    ...
                                    <p className="text-2xl font-medium font-serif text-gray-900">
                                        {t("workflows.customEmptyTitle")}
                                    </p>
                                    <p className="mt-1 text-xs text-gray-400 text-left">
                                        {t("workflows.customEmptyBody")}
                                    </p>
                                    <button
                                        onClick={() => setNewModalOpen(true)}
                                ...
                                <>
                                    <Library className="h-8 w-8 text-gray-300 mb-4" />
                                    <p className="text-2xl font-medium font-serif text-gray-900">
                                        {t("workflows.hiddenEmptyTitle")}
                                    </p>
                                    <p className="mt-1 text-xs text-gray-400 text-left">
                                        {t("workflows.hiddenEmptyBody")}
                                    </p>
                                </>
                            ) : (
                                <>
                                    ...
                                    {wf.is_system ? (
                                        ...
                                        <span className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-600 truncate max-w-full">
                                            ...
                                            <span className="truncate">
                                                {wf.shared_by_name ?? t("workflows.shared")}
                                            </span>
                                        </span>
                                    )}
                                </div>
